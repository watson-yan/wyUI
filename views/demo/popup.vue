<template>
    <div class="init-page">
        <h4 class="title">Alert框</h4>
        <button @click="alertMsg" class="button big info">提示框</button>
...
this.$plugins.Popup.confirm({
    ...
    cb: () => {
        ...
        <h4 class="title">Message框</h4>
        <button @click="messageBox" class="button big primary">message框</button>
        <p>使用方式：</p>
<pre>
